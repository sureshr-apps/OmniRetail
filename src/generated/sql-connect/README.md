...
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await isLicensePlanLevelTaken(isLicensePlanLevelTakenVars);
// Variables can be defined inline as well.
const { data } = await isLicensePlanLevelTaken({ level: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await isLicensePlanLevelTaken(dataConnect, isLicensePlanLevelTakenVars);

console.log(data.licensePlans);

// Or, you can use the `Promise` API.
isLicensePlanLevelTaken(isLicensePlanLevelTakenVars).then((response) => {
  const data = response.data;
  console.log(data.licensePlans);
});
```
...
const ref = isLicensePlanLevelTakenRef(isLicensePlanLevelTakenVars);
// Variables can be defined inline as well.
const ref = isLicensePlanLevelTakenRef({ level: ..., });

// You can also pass in a `DataConnect` instance to the `QueryRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = isLicensePlanLevelTakenRef(dataConnect, isLicensePlanLevelTakenVars);
...
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await listTenantCategories(listTenantCategoriesVars);
// Variables can be defined inline as well.
const { data } = await listTenantCategories({ organizationId: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await listTenantCategories(dataConnect, listTenantCategoriesVars);

console.log(data.organizationMemberships);
console.log(data.categories);

// Or, you can use the `Promise` API.
listTenantCategories(listTenantCategoriesVars).then((response) => {
  const data = response.data;
  console.log(data.organizationMemberships);
  console.log(data.categories);
});
...
const ref = listTenantCategoriesRef(listTenantCategoriesVars);
// Variables can be defined inline as well.
const ref = listTenantCategoriesRef({ organizationId: ..., });

// You can also pass in a `DataConnect` instance to the `QueryRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = listTenantCategoriesRef(dataConnect, listTenantCategoriesVars);
...
// You can use the `await` keyword to wait for the promise to resolve.
const { data } = await listTenantCategoriesTrusted(listTenantCategoriesTrustedVars);
// Variables can be defined inline as well.
const { data } = await listTenantCategoriesTrusted({ organizationId: ..., });

// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await listTenantCategoriesTrusted(dataConnect, listTenantCategoriesTrustedVars);

console.log(data.categories);

// Or, you can use the `Promise` API.
listTenantCategoriesTrusted(listTenantCategoriesTrustedVars).then((response) => {
  const data = response.data;
  console.log(data.categories);
});
```
...
const ref = listTenantCategoriesTrustedRef(listTenantCategoriesTrustedVars);
// Variables can be defined inline as well.
const ref = listTenantCategoriesTrustedRef({ organizationId: ..., });

// You can also pass in a `DataConnect` instance to the `QueryRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = listTenantCategoriesTrustedRef(dataConnect, listTenantCategoriesTrustedVars);
...
// Variables can be defined inline as well.
const { data } = await createTenantSupplier({ id: ..., organizationId: ..., name: ..., contactPerson: ..., phone: ..., email: ..., taxId: ..., address: ..., category: ..., paymentTerms: ..., creditLimit: ..., notes: ..., });
...
// Variables can be defined inline as well.
const ref = createTenantSupplierRef({ id: ..., organizationId: ..., name: ..., contactPerson: ..., phone: ..., email: ..., taxId: ..., address: ..., category: ..., paymentTerms: ..., creditLimit: ..., notes: ..., });
...
// Variables can be defined inline as well.
const { data } = await updateTenantSupplier({ organizationId: ..., id: ..., name: ..., contactPerson: ..., phone: ..., email: ..., taxId: ..., address: ..., category: ..., paymentTerms: ..., creditLimit: ..., notes: ..., });
...
// Variables can be defined inline as well.
const ref = updateTenantSupplierRef({ organizationId: ..., id: ..., name: ..., contactPerson: ..., phone: ..., email: ..., taxId: ..., address: ..., category: ..., paymentTerms: ..., creditLimit: ..., notes: ..., });
...
// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = createTenantCategoryTrustedRef(dataConnect, createTenantCategoryTrustedVars);
...
// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = createTenantSubcategoryTrustedRef(dataConnect, createTenantSubcategoryTrustedVars);
...
// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = deleteTenantServicePersonOutletTrustedRef(dataConnect, deleteTenantServicePersonOutletTrustedVars);
...
// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = deleteTenantCategoryTrustedRef(dataConnect, deleteTenantCategoryTrustedVars);
...
// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = deleteTenantSubcategoryTrustedRef(dataConnect, deleteTenantSubcategoryTrustedVars);
...
// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await provisionTenantEmployeeLoginTrusted(dataConnect, provisionTenantEmployeeLoginTrustedVars);
...
// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = provisionTenantEmployeeLoginTrustedRef(dataConnect, provisionTenantEmployeeLoginTrustedVars);
...
// You can also pass in a `DataConnect` instance to the action shortcut function.
const dataConnect = getDataConnect(connectorConfig);
const { data } = await updateTenantEmployeeLoginTrusted(dataConnect, updateTenantEmployeeLoginTrustedVars);

console.log(data.appUser_update);
console.log(data.organizationMembership_update);
console.log(data.removeAdminRole);
...
// You can also pass in a `DataConnect` instance to the `MutationRef` function.
const dataConnect = getDataConnect(connectorConfig);
const ref = updateTenantEmployeeLoginTrustedRef(dataConnect, updateTenantEmployeeLoginTrustedVars);
