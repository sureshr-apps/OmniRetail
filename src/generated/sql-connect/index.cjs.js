...
const getOrganizationAdministratorTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetOrganizationAdministratorTrusted', inputVars);
}
getOrganizationAdministratorTrustedRef.operationName = 'GetOrganizationAdministratorTrusted';
...
const listTenantCategoriesRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'ListTenantCategories', inputVars);
}
listTenantCategoriesRef.operationName = 'ListTenantCategories';
...
const getTenantSupplierTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetTenantSupplierTrusted', inputVars);
}
getTenantSupplierTrustedRef.operationName = 'GetTenantSupplierTrusted';
...
const getTenantCustomerTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetTenantCustomerTrusted', inputVars);
}
getTenantCustomerTrustedRef.operationName = 'GetTenantCustomerTrusted';
...
const listTenantCategoriesTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'ListTenantCategoriesTrusted', inputVars);
}
listTenantCategoriesTrustedRef.operationName = 'ListTenantCategoriesTrusted';
...
const createTenantCategoryTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'CreateTenantCategoryTrusted', inputVars);
}
createTenantCategoryTrustedRef.operationName = 'CreateTenantCategoryTrusted';
exports.createTenantCategoryTrustedRef = createTenantCategoryTrustedRef;

exports.createTenantCategoryTrusted = function createTenantCategoryTrusted(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(createTenantCategoryTrustedRef(dcInstance, inputVars));
}
;

const createTenantSubcategoryTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'CreateTenantSubcategoryTrusted', inputVars);
}
createTenantSubcategoryTrustedRef.operationName = 'CreateTenantSubcategoryTrusted';
exports.createTenantSubcategoryTrustedRef = createTenantSubcategoryTrustedRef;

exports.createTenantSubcategoryTrusted = function createTenantSubcategoryTrusted(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(createTenantSubcategoryTrustedRef(dcInstance, inputVars));
}
;
...
const getTenantProductTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetTenantProductTrusted', inputVars);
}
getTenantProductTrustedRef.operationName = 'GetTenantProductTrusted';
...
const resolveTenantEmployeeIdentityTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
const deleteTenantOutletTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.deleteTenantOutletTrustedRef = deleteTenantOutletTrustedRef;

exports.deleteTenantOutletTrusted = function deleteTenantOutletTrusted(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(deleteTenantOutletTrustedRef(dcInstance, inputVars));
}
;

const deleteTenantEmployeeTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.deleteTenantEmployeeTrustedRef = deleteTenantEmployeeTrustedRef;

exports.deleteTenantEmployeeTrusted = function deleteTenantEmployeeTrusted(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(deleteTenantEmployeeTrustedRef(dcInstance, inputVars));
}
;

const deleteTenantServicePersonTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.deleteTenantServicePersonTrustedRef = deleteTenantServicePersonTrustedRef;

exports.deleteTenantServicePersonTrusted = function deleteTenantServicePersonTrusted(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(deleteTenantServicePersonTrustedRef(dcInstance, inputVars));
}
;

const deleteTenantServicePersonOutletTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'DeleteTenantServicePersonOutletTrusted', inputVars);
}
deleteTenantServicePersonOutletTrustedRef.operationName = 'DeleteTenantServicePersonOutletTrusted';
exports.deleteTenantServicePersonOutletTrustedRef = deleteTenantServicePersonOutletTrustedRef;

exports.deleteTenantServicePersonOutletTrusted = function deleteTenantServicePersonOutletTrusted(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(deleteTenantServicePersonOutletTrustedRef(dcInstance, inputVars));
}
;

const deleteTenantCustomerTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.deleteTenantCustomerTrustedRef = deleteTenantCustomerTrustedRef;

exports.deleteTenantCustomerTrusted = function deleteTenantCustomerTrusted(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(deleteTenantCustomerTrustedRef(dcInstance, inputVars));
}
;

const deleteTenantSupplierTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.deleteTenantSupplierTrustedRef = deleteTenantSupplierTrustedRef;

exports.deleteTenantSupplierTrusted = function deleteTenantSupplierTrusted(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(deleteTenantSupplierTrustedRef(dcInstance, inputVars));
}
;

const deleteTenantProductTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.deleteTenantProductTrustedRef = deleteTenantProductTrustedRef;

exports.deleteTenantProductTrusted = function deleteTenantProductTrusted(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(deleteTenantProductTrustedRef(dcInstance, inputVars));
}
;

const deleteTenantCategoryTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'DeleteTenantCategoryTrusted', inputVars);
}
deleteTenantCategoryTrustedRef.operationName = 'DeleteTenantCategoryTrusted';
exports.deleteTenantCategoryTrustedRef = deleteTenantCategoryTrustedRef;

exports.deleteTenantCategoryTrusted = function deleteTenantCategoryTrusted(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(deleteTenantCategoryTrustedRef(dcInstance, inputVars));
}
;

const deleteTenantSubcategoryTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return mutationRef(dcInstance, 'DeleteTenantSubcategoryTrusted', inputVars);
}
deleteTenantSubcategoryTrustedRef.operationName = 'DeleteTenantSubcategoryTrusted';
exports.deleteTenantSubcategoryTrustedRef = deleteTenantSubcategoryTrustedRef;

exports.deleteTenantSubcategoryTrusted = function deleteTenantSubcategoryTrusted(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(deleteTenantSubcategoryTrustedRef(dcInstance, inputVars));
}
;

const getTenantOutletTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetTenantOutletTrusted', inputVars);
}
getTenantOutletTrustedRef.operationName = 'GetTenantOutletTrusted';
...
const provisionTenantEmployeeLoginTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.provisionTenantEmployeeLoginTrustedRef = provisionTenantEmployeeLoginTrustedRef;

exports.provisionTenantEmployeeLoginTrusted = function provisionTenantEmployeeLoginTrusted(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
  return executeMutation(provisionTenantEmployeeLoginTrustedRef(dcInstance, inputVars));
}
;

const updateTenantEmployeeLoginTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.updateTenantEmployeeLoginTrustedRef = updateTenantEmployeeLoginTrustedRef;

exports.updateTenantEmployeeLoginTrusted = function updateTenantEmployeeLoginTrusted(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
const changeTenantEmployeeStatusWithLoginTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
...
exports.changeTenantEmployeeStatusWithLoginTrustedRef = changeTenantEmployeeStatusWithLoginTrustedRef;

exports.changeTenantEmployeeStatusWithLoginTrusted = function changeTenantEmployeeStatusWithLoginTrusted(dcOrVars, vars) {
  const { dc: dcInstance, vars: inputVars } = validateArgs(connectorConfig, dcOrVars, vars, true);
...
const getTenantEmployeeTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetTenantEmployeeTrusted', inputVars);
}
getTenantEmployeeTrustedRef.operationName = 'GetTenantEmployeeTrusted';
...
const getTenantServicePersonTrustedRef = (dcOrVars, vars) => {
  const { dc: dcInstance, vars: inputVars} = validateArgs(connectorConfig, dcOrVars, vars, true);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetTenantServicePersonTrusted', inputVars);
}
getTenantServicePersonTrustedRef.operationName = 'GetTenantServicePersonTrusted';
